 ...
 */
public class AllStatisticCallback extends AbstractCallback<CompleteStatistic> {
    private final EventBus mBus;
    private final String TAG = getClass().getSimpleName();

    public AllStatisticCallback(EventBus mBus) {
        this.mBus = mBus;
    }
    ...
    @Override
    public void success(final CompleteStatistic statistic, Response response) {
        final ReceivedCompeleteStatisticEvent event = ReceivedCompeleteStatisticEvent.getEvent(statistic);
        mBus.post(event);
    }
