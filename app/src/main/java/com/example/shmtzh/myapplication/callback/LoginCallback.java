 ...
 */
public class LoginCallback extends AbstractCallback<LoginModel> {
    private final EventBus mBus;
    private final String TAG = getClass().getSimpleName();

    public LoginCallback(EventBus mBus) {
        this.mBus = mBus;
    }
    ...
    @Override
    public void success(final LoginModel login, Response response) {
        final ReceivedLoginEvent event = ReceivedLoginEvent.getEvent(login);
        mBus.post(event);
    }
